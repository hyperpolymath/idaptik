...
:experimental:
:url-github: https://github.com/hyperpolymath/idaptiky
:url-gitlab: https://gitlab.com/hyperpolymath/idaptiky
:url-bitbucket: https://bitbucket.org/hyperpolymath/idaptiky
:url-codeberg: https://codeberg.org/hyperpolymath/idaptiky

IDApTIK runtime and toolchain
...
idaptiky is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
